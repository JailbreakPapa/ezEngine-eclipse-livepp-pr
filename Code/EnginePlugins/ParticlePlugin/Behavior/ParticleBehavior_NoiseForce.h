...
class EZ_PARTICLEPLUGIN_DLL ezParticleBehaviorFactory_NoiseForce final : public ezParticleBehaviorFactory
{
  EZ_ADD_DYNAMIC_REFLECTION(ezParticleBehaviorFactory_NoiseForce, ezParticleBehaviorFactory);

public:
  ezParticleBehaviorFactory_NoiseForce();
...
class EZ_PARTICLEPLUGIN_DLL ezParticleBehavior_NoiseForce final : public ezParticleBehavior
{
  EZ_ADD_DYNAMIC_REFLECTION(ezParticleBehavior_NoiseForce, ezParticleBehavior);
