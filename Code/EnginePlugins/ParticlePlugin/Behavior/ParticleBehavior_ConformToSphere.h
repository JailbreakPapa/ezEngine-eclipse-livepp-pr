...
class EZ_PARTICLEPLUGIN_DLL ezParticleBehaviorFactory_ConformToSphere final : public ezParticleBehaviorFactory
{
  EZ_ADD_DYNAMIC_REFLECTION(ezParticleBehaviorFactory_ConformToSphere, ezParticleBehaviorFactory);

public:
  ezParticleBehaviorFactory_ConformToSphere();
...
class EZ_PARTICLEPLUGIN_DLL ezParticleBehavior_ConformToSphere final : public ezParticleBehavior
{
  EZ_ADD_DYNAMIC_REFLECTION(ezParticleBehavior_ConformToSphere, ezParticleBehavior);
